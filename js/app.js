...
paginatedData.forEach((el)=>{
  ...
  function displayPagination(arrData,rowPerPage){
    ...
    const pagesCount=Math.ceil(arrData.length / rowPerPage); //округляєм ціле +чи дробне значення
  ...
  function displayPaginationBtn(page){
    ...
    liEl.addEventListener('click',()=>{
      currentPage=page;
      displayList(postsDate, rows, currentPage);
...
displayList(postsDate, rows, currentPage);
displayPagination(postsDate, rows);
